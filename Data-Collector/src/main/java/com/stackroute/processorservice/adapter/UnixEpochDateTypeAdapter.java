package com.stackroute.processorservice.adapter;
...
public class UnixEpochDateTypeAdapter
    ...
    public static final TypeAdapter<Date> unixEpochDateTypeAdapter = new UnixEpochDateTypeAdapter();

    public UnixEpochDateTypeAdapter() {
    }

    public TypeAdapter<Date> getUnixEpochDateTypeAdapter() {
