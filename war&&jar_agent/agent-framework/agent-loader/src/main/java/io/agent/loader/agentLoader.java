...
public class agentLoader {
    ...
    public static void main(String[] args) throws Exception {
        ...
        agentLoader.loadagent(agentJar, pid, port);
    }

    private static void loadagent(String agentJar, int pid, int port) throws Exception {
    ...
    private static void printUsageAndExit() {
        System.err.println("Usage: java -cp $JAVA_HOME/lib/tools.jar:/path/to/agent-loader.jar io.agent.loader.agentLoader -agent /path/to/agent.jar -port 9300 -pid <pid>");
        System.exit(-1);
    }
}
